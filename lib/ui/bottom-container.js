...
export default class BottomContainer extends HTMLElement {
  ...
  setCount({Project, File, Line}) {
    this.tags.get('Project').count = Project
    this.tags.get('File').count = File
    this.tags.get('Line').count = Line
    // TODO: Status icon count
  }
  ...
  static create() {
    return document.createElement('linter-bottom-container')
  }
}
