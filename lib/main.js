...
class Linter {
  ...
  constructor() {
    ...
    this.registryProjects.onShouldLint((editor) => {
      this.registryLintersInit()
      this.registryLinters.lint({ onChange: false, editor, scope: 'file' })
    })
    this.registryProjects.onShouldClear((editor) => {
      this.registryMessagesInit()
      this.registryMessages.deleteByBuffer(editor.getBuffer())
    })
  ...
  registryEditorsInit() {
    ...
    this.registryEditors.observe((editorLinter) => {
      editorLinter.onShouldLint((onChange) => {
        this.registryLintersInit()
        this.registryLinters.lint({ onChange, editor: editorLinter.getEditor(), scope: null })
      })
