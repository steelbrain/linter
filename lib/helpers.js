...
export function flagMessages(inputs: Array<Message>, cache: Map<string, Message>) {
  // inputs check
  if (inputs === undefined || cache === undefined || inputs.length === undefined || cache.size === undefined) {
    return null
  }
