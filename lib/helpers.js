...
export const $version = Symbol('Linter version')
export const $activated = Symbol('Linter activation status')
export const $requestLatest = Symbol('Linter latest request')
export const $requestLastReceived = Symbol('Linter last received request')
