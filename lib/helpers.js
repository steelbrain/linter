...
export function flagMessages(inputs: Array<Message>, oldMessages: Array<Message>){
  // inputs check
  if (inputs === undefined || cache === undefined || inputs.length === undefined || oldMessages.length === undefined) {
    return null
  }
