...
export default class EditorLinter {
  ...
  constructor(editor: TextEditor) {
    ...
    // This option is for beautifiers, if they change contents of the editor and save
    // Linter should count that group of events as one.
    this.subscriptions.add(
      this.editor.onDidSave(debounce(() => this.emitter.emit('should-lint', false)), 50, { leading: true }),
    )
