...
function validateLinter(linter: Linter, version: 1 | 2): boolean {
  ...
  if (linter && typeof linter === 'object') {
    ...
    if (typeof linter.lintsProject !== 'undefined' && typeof linter.lintsProject !== 'boolean') {
      messages.push('Linter.lintsProject must either be undefined or a boolean')
    }
    ...
    if (typeof linter.isFileIgnored !== 'undefined' && typeof linter.isFileIgnored !== 'function') {
      messages.push('Linter.isFileIgnored must either be undefined or a function')
    } else if (linter.isFileIgnored) {
      shouldProvideName = true
    }
    if (typeof linter.isDirectoryIgnored !== 'undefined' && typeof linter.isDirectoryIgnored !== 'function') {
      messages.push('Linter.isDirectoryIgnored must either be undefined or a function')
    } else if (linter.isDirectoryIgnored) {
      shouldProvideName = true
    }
    if (typeof linter.name !== 'string') {
      if (version === 2 || shouldProvideName) {
