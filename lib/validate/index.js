    ...
    for (let i = 0, { length } = entries; i < length; ++i) {
      ...
      if (
        ...
        ((typeof message.text !== 'string' &&
          (typeof message.html !== 'string' && !(message.html instanceof HTMLElement))) ||
      ...
      if (
        !invalidFix &&
        message.fix &&
        (typeof message.fix.range !== 'object' ||
          typeof message.fix.newText !== 'string' ||
          (message.fix.oldText && typeof message.fix.oldText !== 'string'))
      ) {
        invalidFix = true
